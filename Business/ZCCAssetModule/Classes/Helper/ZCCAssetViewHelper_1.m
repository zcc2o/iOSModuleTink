//
//  ZCCAssetViewHelper_1.m
//  ZCCAssetModule
//

#import "ZCCAssetViewHelper_1.h"

@implementation ZCCAssetViewConfig_1
- (instancetype)init {
    self = [super init];
    if (self) {
        _height = 44.0;
...
@implementation ZCCAssetViewHelper_1

+ (UIView *)buildCardWithConfig:(ZCCAssetViewConfig_1 *)config {
...
+ (CGFloat)heightForConfig:(ZCCAssetViewConfig_1 *)config width:(CGFloat)width {
...
+ (void)applyStyle:(ZCCAssetViewConfig_1 *)config toView:(UIView *)view {
